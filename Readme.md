<!--
  ╔══════════════════════════════════════════════════════════════════╗
  ║         CYBER KING · THE PIXEL TAMER · README.md               ║
  ║  ⚠ GitHub strips <style> & <script> — animations work only     ║
  ║    in raw HTML preview (VS Code, local browser, etc.)           ║
  ╚══════════════════════════════════════════════════════════════════╝
-->
...
.hbdot:nth-child(1) { animation: bdot 1.2s 0.0s infinite; }
...
@keyframes randomGlow {
  ...
  80%, 90% {
    ...
    border-color: #fff; color: #fff; background: rgba(255,255,255,0.07);
  }
}
.px-badge:hover { background: #fff; color: #000; transition: all 0.05s; }
...
.ac { aspect-ratio: 1; background: #111; animation: acPulse 5s ease-in-out infinite; }
...
@keyframes acPulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.6; } }
...
(function() {
  ...
  if (!g) return;
  var lvls = ['', 'l1', 'l2', 'l3', 'l4'];
  var w = [0.40, 0.28, 0.17, 0.10, 0.05];
  for (var i = 0; i < 364; i++) {
